        ...
        <div class="grid grid-cols-1 gap-4 mb-8 lg:grid-cols-3 xl:grid-cols-4">
            <div class="lg:col-span-2 xl:col-span-3">
                <form @submit.prevent="handleSearch" class="flex items-center gap-2">
                    ...
                    <button type="submit"
                        class="inline-flex items-center py-2 px-3 text-sm font-medium text-white bg-gray-700 rounded-lg border border-gray-700 hover:bg-gray-800 focus:ring-4 focus:outline-none focus:ring-gray-300">
