  ...
  <footer class="bg-gray-200 text-gray-600 body-font ">
    ...
    >
      <div class="grid md:grid-cols-3 gap-8">
        ...
        <div class="mx-auto text-center md:text-left lg:py-8">
          <h1
            class="mb-4 text-4xl title-alta-2 tracking-tight leading-none text-gray-900 md:text-2xl lg:text-2xl "
          >
            SOBRE NOSOTROS
          </h1>
          <p
            class="mb-4 text-sm font-light text-black lg:text-sm "
          >
            Homes Guatemala es una empresa dedicada a promover propiedades y
            proyectos inmobiliarios, fundada en 2007. Ofrecemos una variedad de
            proyectos, apartamentos, casas, oficinas, locales comerciales, y
            bodegas en renta y venta en Guatemala.
          </p>
          <a
            class="mb-4 text-sm font-light text-black lg:text-sm  underline"
            href="#"
            >MÁS INFORMACIÓN</a
          >
        </div>
        <div class="mx-auto text-center md:text-left lg:py-8">
          <h1
            class="mb-4 text-4xl font-regular tracking-tight leading-none text-gray-900 md:text-2xl lg:text-2xl "
          >
            CONTÁCTENOS
          </h1>
          <p
          ...
          <ul
            class="text-left text-sm text-gray-500 space-y-2 "
          >
            ...
            <li class="flex items-center space-x-3 rtl:space-x-reverse">
              ...
              <span> Zona 10 Colonia Oakland II</span>
            </li>
          </ul>
        </div>
      </div>
    ...
    <div class="bg-gray-100">
      ...
      >
        ...
        >
        <p class="text-gray-900 text-sm text-center mr-4 sm:text-left">
            Hecho por:      
        </p>
        <img class="w-[120px] h-auto" src="https://vylaris.ar/_nuxt/logohorizontalcolor.795976b7.png" alt="" srcset="">
        </span>
      </div>
    </div>
  </footer>
